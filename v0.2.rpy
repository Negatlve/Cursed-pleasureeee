...
label linda_handjob:
    ...
    you "Хочу, чтобы ты поработала ручкой. Хорошенько и без отговорок."

    l "Ты серьёзно сейчас? Смотри на меня. Я беременна, а ты..."

    scene 331 with dissolve

    you "Руки вниз. Не заставляй повторять."

    scene 332 with dissolve

    "Ты медленно стягиваешь трусы. Член выскальзывает наружу — тяжёлый, набухший, уже полностью стоячий."

    you "Смотри, во что ты меня привела."

    scene 333 with dissolve

    "Линда смотрит вниз. Её взгляд на секунду задерживается на твоём члене. Она быстро моргает и отводит глаза."

    l "Ты... совсем больной. Это же мой племянник..."

    scene 334 with dissolve

    you "Для начала убери руку. Хочу видеть обе груди. Без утайки."

    scene 335 with dissolve

    "Линда нехотя убирает руку с груди. Смотрит на тебя с холодной злостью."

    l "Доволен? Или ещё что-то придумаешь, чтобы меня унизить?"

    scene 336 with dissolve

    "Ты показываешь пальцем вниз, прямо на свой член."

    you "Бери в руку. И начинай двигать. Не заставляй меня объяснять дважды."

    scene 337 with dissolve

    "Линда смотрит тебе в глаза. В её взгляде смесь ненависти, унижения и чего-то ещё."

    l "Ты правда думаешь, что я буду делать это с улыбкой на лице?"

    scene 339 with dissolve

    "Она протягивает правую руку и нехотя обхватывает твой член. Пальцы холодные и чуть дрожат."

    l "Ты меня достал... настоящий маленький ублюдок."
