...
label handjob_cum:
    ...
    s "Мам? Ты ещё там? Мне срочно нужно, я сейчас открою!"
    ...
    if persistent.linda_door_locked:
        ...
        "Сара недовольно фыркает и уходит."
        ...
        s "А я просила, чтобы ты не трахалась с племянником у меня под носом! Это что за хуйня?! Тебе что, своих молодых членов не хватает?!"

        you "(внутренне) *Хех... интересно, кого она имеет в виду*"
