...
label boobjob_cum_face:
    ...
    scene 372 
    you "Оооо... блять, это было охуенно... прямо на твоё лицо..."

    scene 373 with dissolve
    l "Ты... ты совсем охуел?! Кончил мне на лицо, ублюдок?!"
    you "Я... не смог сдержаться, тётя. Твои сиськи и лицо — идеально подошли."

   

    scene 376 with dissolve
    l "Ты кончил мне на лицо... как какой-то порноактёр..."
    ...
    scene 380 with dissolve
    #сара что-то говорит, кадр со стороны где она в дверь стучит. 
    ...
    if persistent.linda_door_locked:
        ...
        # Сара открывает дверь и видит мать с кончей на лице + гг рядом. Шок + злость
        s "Мам?! Что за хуйня... у тебя на лице... это сперма?!"

        scene 382 with dissolve
        # Сара агрессирует, Линда злится и указывает на дверь
        l "Сара! Я же просила не входить! Ты ничего не понимаешь, выйди отсюда!"
        you "Сара, а ты вовремя. Хочешь присоединиться? Места ещё хватит."
        l "Заткнись, ублюдок!"

        scene 383 with dissolve
        # Все втроём, диалог между Линдой и Сарой
        s "Ты серьёзно?! Ты ему дрочила сиськами, а он тебе на лицо кончил?! Ты совсем ебанулась?!"
        l "Сара, это не то, что ты думаешь! Просто... просто выйди, пожалуйста!"

        scene 384 with dissolve
        # Сара уже почти закрывает дверь
        s "Вы оба — конченые. Идите нахуй."
