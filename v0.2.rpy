...
label handjob_cum:
    ...
    scene 347 
    #здесь линда все еще держит член, все лицо в конче, удивлена и озлобленна. 
    you "Оооо, это было охуенно."
    l ""
    scene 348
    #линда раздвинула руки по бокам, приняла еще более удивленно-агрессивную позу и спрашивает какого хуя ты так много кончил и не предупредил её, гг что-то отвечает
    scene 349 
    #гг в кадре, рука за головой пытается придумать оправдание, в конце их диалога слышит стук в дверь, это сара стоит перед дверью, спрашивает линду скоро ли она.   
    scene 380
    #кадр сары за дверью, она стучит в дверь, и говорит что ей срочно надо войти и она сейчас откроет дверь. типа извини мам, но мне срочно.
    scene 350
    #гг и линда оборачиваются на дверь, линда с испугом кричит ей не смей входить.
    #и дальше тут развилка, вот для чего был выбор закрывать дверь или нет: если дверь закрыта то:
    #  в scene 350 продолжается диалог, она просит открыть дверь, линда говорит ей подождать.
    # scene 356 тот же почти ракурс, но гг уже полностью повёрнут к двери. сара недовольна и вроде она ушла. происходит диалог между гг и линдой
    # scene 357 гг подходит близко к линде и говорит ей что-то провокационное мб про сару или ещё что-то, ну чтобы просто закончить уже эту сцену
    # scene 358 гг подходит к двери и уже открывает её за ручку, последние фразы от линды и гг перед концом цены. 
    # если дверь осталась открыта то:
    # scene 351(я буду дальше коротко описывать, сам накидывай диалоги какие-хочешь по контексту потом исправим) сара открывает дверь и видит как перед ней сидит её мать с кончой и лице и гг.  
    #линда зла, что та просила её не заходить. сара кричит в ответ ей что это за хуйня
    #scene 353 та же сцена, продолжение. только от лица линды. диалог сары и линды продолжается на повышенных тонах. 
    #линда пытается как-то отмазаться, а сара прокидывает фразу по типу "тебе что не хватает молодых членов", гг это слышит и говорит про себя типа "хаха", ну типа он понял про кого речь(про конора)
    #линда в шоке от фразы сары.
    #scene 354 тут уже фокус на гг, он тоже вмешивается и вставляет свои 5 копеек в адресс сары, говоря что-то провокационное в своем духе
    #scene 355 сара обижается, посылает их нахуй, оборачивается и уходит, закрывая дверь. это кадр именно где она уже почти закрыла её и говорит им это на прощание.
    # scene 356, 357, 358 дальше повторяются из первой части, только чуть изменяются диалоги из-за контекста того, что их сара спалила. 
