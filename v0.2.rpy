...
label linda_footjob:
    ...
    #гг показывает пальцем на её ноги и говорит что хочет footjob, линда недовольна этим, унижает его футфетишистом
    scene 331 with dissolve

    scene 332 with dissolve #снял трусы
    you "Ну как? Нравится вид?"
    
    scene 330 #линда с отвращением смотрит на член гг, диалог продолжается их. 
    l "Ты... серьёзно? Это мерзко."
    you ""
    scene 399
    #pov от лица гг. он взял левую ступню в левую руку, правую - в правую. хочет прижать ими свой член. 
    #дальше идет анимация-катсцена этого - anim20, просто быстрая анимация перехода, одноразовая, без диалогов.
    scene 400
    #прижал свой член ступнями линды
    #дальше тут начинаются анимации, надо сделать ровно такую же схему и код как в boobjob и handjob. типа по очереди идут анимации, во время анимаций есть диалоги.
    #вот их порядок: anim18 - pov, как он дрочит ногами линды себе член. дальше - anim19 - тоже самое, но вид сбоку. дальше - анимация pov линда теперь без помощи рук гг дрочит ему ногами член(он попросил её об этом в прошлой анимации)
    #дальше - anim22 - тоже самое, только вид сбоку. 
    #дальше идет scene 408 - это предcum сцена, где гг взял свой член в руку и готовится кончить. последний их диалог перед тем как он кончит. 
    #дальше идет scene 409 - линда отвернула голову, чтобы не смотреть как он кончает, вот это точно последний их диалог. 
    #дальше идет анимация-катсцена как он кончает - anim23
    scene 410 
    #сцена как он кончил, pov. у него член в руке и и он смотрит на сперу на ногах линды. здесь он гооврит то, что говорит любой парень после того как кончит, после оргазма.
    scene 411
    #кадр на лице гг, он уже отходит от оргазма но все еще доволен, говорит как это охуенно. 
    scene 412
    #кадр на линде, она недовольна что он кончил на неё, недовольна что так много. гг как-то язвительно  в своем стиле ей отвечает.
    scene 413
    #линда поднимает голову на лицо гг, то же что-то отвечает на это гг. в конце их диалога происходит стук в дверь, это сара спрашивает линду долга ли она еще и что ей надо в туалет(ну как в handjob, boobjob сцене)
    scene 414
    #линда повернула голову в сторону двери и говорит саре подождать, она занята. 
    scene 380
    #кадр от лица сары, которая долбится  в дверь. сара просит еще сильнее впустить её. 
    scene 416
    #кадр от лица линды, она говорит ей что не может открыть дверь бла-бла, типа жди. 
    #сара делает последнее предупреждение, что оан ен может ждать и  если она сейчас не откроет, то она выбьет эту дверь и зайдет типа силой туда всё равно. 
    #дальше идет типичная развилка открыта дверь или нет, сделай пока просто заглушку, диалоги и сцены я потом сам накину туда. 
    jump v02_end
