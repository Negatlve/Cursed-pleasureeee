...
label linda_footjob:
    ...
    scene 333 with dissolve
    l "Ты... серьёзно? Это мерзко. Убери это от меня, больной."
    scene 330 with  dissolve
    you "Неа. Давай поднимай свои ступни и прижимай к моему члену. Будет тебе урок, как угождать племяннику."

    scene 399 with dissolve
    #pov от лица гг. он взял левую ступню в левую руку, правую - в правую. 
    you "Сейчас я сам возьму твои ступни... вот так... и хорошенько прижму ими свой член."
    l "Нет! Не надо... это жесть какая-то... убери руки!"
    $ renpy.movie_cutscene("videos/anim20.webm")

    scene 400 
    #прижал свой член ступнями линды + сразу диалог (чтобы не было пустой сцены)
    you "Ох бля... твои ступни такие мягкие и тёплые. Идеально обхватывают член."
    l "Это отвратительно... Ты реально получаешь кайф от такого? Футфетишист хренов."
...
label footjob_view21:
    ...
    l "Я... я делаю это только потому что ты меня заставляешь, ублюдок. Не смей говорить, что мне нравится."
...
label footjob_cum:
    ...
    you "Фух... твои ножки просто созданы для footjob. Лучшее, что я пробовал."

    scene 412 with dissolve
    l "Ты... ты кончил столько?! Всё мои ноги в твоей сперме... Какая же гадость!"
    you "Хех, считай это комплиментом. Много спермы — значит сильно возбудился от твоих ступней."
    ...
    l "Не смей!"
    # развилка с дверью (как в handjob/boobjob) — оставил заглушку, как ты просил
    # (persistent.linda_door_locked и ветки потом сам добавишь)
