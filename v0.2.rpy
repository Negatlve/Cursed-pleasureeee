...
label after_bath:
    ...
    you "Фух... наконец-то выбрался. Тётя Линда в ванне — это было что-то."
    ...
    yth "*Чёрт, это было охуенно. Она дрочила мне, как я и хотел... я кончил ей. Теперь она полностью моя. Надо одеться и на обед, пока все не разошлись.*"
    you "Пора в одежду. На обед уже зовут."

    scene 426
    #переоделся стоит смотрит в зеркало
    you "Переоделся... стою перед зеркалом. Рожа довольная. И телефон прихватил — для Милы эти фотки из историй очень даже пригодятся."

    scene 427
    #по пути на обед берет телефон, думая о том, что он понадобится(он понадобится, чтобы показать миле её фотки)
    you "Да... телефон. Хехе, покажу ей, какая она шлюшка на тех видосах. Пусть знает, что я всё вижу."
    ...
    you "Привет, семейка. Извините, что задержался."
    ...
    s "Да, долго ты."
    j "Опять где-то шлялся, урод?"
    mo "Садись уже, сын. Еда остывает."

    scene 431 
    #гг спрашивает как бы с намёком у линды что-то провокационное, что-то про недавнюю сцену в душе.
    you "Линда, а как там в ванной? Вода горячая была? Или тебе больше по твёрдым вещам?"
